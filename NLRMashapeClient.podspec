#
#  Be sure to run `pod spec lint NLRMashapeClient.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/natanrolnik/NLRMashapeClient"
  ...
  s.social_media_url   = "http://twitter.com/natanrolnik"
  ...
  s.source       = { :git => "https://github.com/natanrolnik/NLRMashapeClient.git", :tag => "0.1.1" }
  ...
  s.source_files  = "NLRMashapeClient/NLRMashapeClient.{h,m}", "NLRMashapeClient/NLRMashapeRequestSerializer.{h,m}"
